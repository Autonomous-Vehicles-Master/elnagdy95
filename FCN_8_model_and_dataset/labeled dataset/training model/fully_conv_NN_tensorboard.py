...
NAME = "full_CNN_model{}".format(int(time.time()))


# Load training images
train_images = pickle.load(open("data.p", "rb" ))
...
#logdir = r"E:\THI MASTERS\Semestre1\Electives\Autonomous Vehicles by Machine Learning Algorithms\Project\New folder\keras-yolo3-master\Project Upload version\FCN8_model_and_dataset\labeled dataset\training model\logs" + datetime.now().strftime("%Y%m%d-%H%M%S")
tensorboard_callback = keras.callbacks.TensorBoard(log_dir='logs\{}'.format(NAME))
